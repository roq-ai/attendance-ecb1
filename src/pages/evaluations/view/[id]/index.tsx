...
import { getEvaluationById } from 'apiSdk/evaluations';
...
function EvaluationViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<EvaluationInterface>(
    () => (id ? `/evaluations/${id}` : null),
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('evaluation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/evaluations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Evaluation Period" text={data?.evaluation_period} />

                <FormListItem label="Attendance Percentage" text={data?.attendance_percentage} />
