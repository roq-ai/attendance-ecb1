...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['school', 'attendance.count', 'evaluation.count', 'leave.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'division.contains', 'group_name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'name', header: 'Name', accessorKey: 'name' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.birthdate ? format(parseISO(record?.birthdate as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'division', header: 'Division', accessorKey: 'division' },
    { id: 'group_name', header: 'Group Name', accessorKey: 'group_name' },
    ...
    hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'evaluation',
          header: 'Evaluation',
          accessorKey: 'evaluation',
          cell: ({ row: { original: record } }: any) => record?._count?.evaluation,
        }
      : null,
