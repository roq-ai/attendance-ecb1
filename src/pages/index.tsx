  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience streamlined student management with Attendance - your all-in-one solution for marking attendance, tracking student data, and conducting comprehensive evaluations. All student information, at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1629805019330-15570b096690?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhdHRlbmRhbmNlfGVufDB8fHx8MTY5NDUwNDI5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience streamlined student management with Attendance - your all-in-one solution for marking attendance, tracking student data, and conducting comprehensive evaluations. All student information, at your fingertips.`}
            </Text>
            <Box
